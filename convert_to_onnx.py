...
PATH_TO_MODEL = "/Users/ntdat/Downloads/112_Classify_Adam_Epoch_138_Batch_3864_94.916_98.475_Time_1632990423.1972141_checkpoint.pth"

net = mobilenetv3_small_multitask()
load_state_dict(net, torch.load(PATH_TO_MODEL, map_location="cpu")["model"])
net.eval()
dummy_input = torch.randn(1, 3, 112, 112)
model_name = "112_Classify_Adam_Epoch_138_Batch_3864_94.916_98.475_Time_1632990423.1972141_checkpoint.onnx"
...
os.system(
    "python3 /opt/intel/openvino_2021.2.185/deployment_tools/model_optimizer/mo.py --input_model {} --scale_values '[127.5,127.5,127.5]' --mean_values '[127.5,127.5,127.5]' --input_shape '[1,3,112,112]' --output_dir ~/Downloads/ --reverse_input_channels".format(
        "/Users/ntdat/Downloads/{}".format(model_name)))
